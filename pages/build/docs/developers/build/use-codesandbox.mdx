...
- no login required
- evaluate your rholang code (read only) for free on the rhonix testnet
- evaluate your rholang code (rev cost) on the rhonix mainnet

## Write rholang code

The language in which you write your Dapp ist rholang, which is beeing executed decentralized on the rhonix network.

![rholang-code](public/images/docs/build/codesandbox/rho-file.png)
...
## Execute your rholang code on the rhonix network

To execute you rholang code on the rhonix network you can run choose between _testnet_ or _mainnet_:
...
![view](public/images/docs/build/codesandbox/rho-view.png)
...
![title](public/images/docs/build/codesandbox/rho-title.png)
...
![search](public/images/docs/build/codesandbox/rho-search.png)
