...
description: Running RNode (Docker)
---
...
> Please fill in the `<bootstrap ID>`.
...
> please fill in you own userpath `-v C:\Users\<your-user-name>\Desktop\Rnode`. Also copy conf files into Rnode folder: [link](https://github.com/RhonixLabs/rhonix/blob/dev/node/src/main/resources/defaults.conf)
...
- Bootstrap address - Enter the address of the bootstrap node you want to connect with. See RNode bootstrap addresses for bootstrap nodes supported by the Rhonix core development team.
