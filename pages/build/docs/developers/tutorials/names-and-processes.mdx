...
![The game of telephone is perfect to simulate message forwarding in rholang.](public/images/docs/build/tut-1/names-telephone.png)
...
![The message never seems to get there correctly. I blame Bob.](public/images/docs/build/tut-1/names-telephoneChangedMessage.png)
...
![Opposites attract](public/images/docs/build/tut-1/names-inverse.png)
...
![What kind of name is that](public/images/docs/build/tut-1/names-myNameIs.png)
...
![telefone](public/images/docs/build/tut-1/names-telephoneFork.png)
