...
![In general, the winner of this pushup competition can't be determined until both participants are finished.](public/images/docs/build/tut-1/join-pushups.png)
...
![No use in grabbing just one set of mail. Might as well wait until the second set](public/images/docs/build/tut-1/join.png)
