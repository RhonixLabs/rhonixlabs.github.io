...
![This radio navigation aid helps airplanes navigate by broadcasting the same message over and over](public/images/docs/build/tut-1/send-peek-broadcasting.png)
...
![Peeking at a message allows you to read it without consuming it.](public/images/docs/build/tut-1/send-peek-letterPeek.png)
