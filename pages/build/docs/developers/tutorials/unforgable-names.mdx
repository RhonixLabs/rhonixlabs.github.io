...
![Although the messages can no longer be stolen, they can still be eavesdropped on. You've been warned.](public/images/docs/build/tut-1/unforgable-eavesdropping.png)
...
![We acknowledge communications all the time in conversations](public/images/docs/build/tut-1/unforgable-roger.png)
