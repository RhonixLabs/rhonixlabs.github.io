...
Similarly, we can match sentence patterns. The sentences "I like cheese" and "I like pandas" both match the pattern "I like \_\_\_\_". But "I have a dog" does not match that pattern. Rholang allows programmers to use pattern matching to control program execution. That is, different code can run depending whether a process matches a certain pattern.
...
![patternmatching](public/images/docs/build/tut-1/patternmatching-lookingForMessages.png)
...
![Yummy, syntactic sugar. Now with extra curly braces.](public/images/docs/build/tut-1/patternmatching-sugar.png)
