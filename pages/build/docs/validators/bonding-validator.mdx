...
The information on this page is for people who will help launch and validate on the Rhonix public mainnet.
...
RNode features integration with Prometheus. [These instructions](https://github.com/RhonixLabs/rhonix/blob/master/docker/node/README.md) describe a method for getting started with RNode metrics collection and display using Prometheus via Docker-compose.
