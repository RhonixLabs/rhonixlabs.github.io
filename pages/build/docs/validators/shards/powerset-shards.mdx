---
title: Powerset shards (Proposal)
description: Powerset shards (Proposal)
---
...
A validator is a participant in the weaver protocol. Weaver requires each validator to know what the entire set of validators is. Let V be the set of validators.
