# Setup a Rhonix network in the cloud with terraform

Your can also start a complete new Rhonix network on large cloud providers (AWS, Google Cloud, IBM).

## Start Network

> You first have to download the data from: [Rhonix-terraform](https://github.com/RhonixLabs/rhonix-testnet-node).
