...
Much of the innovations that Rhonix brings to the world of blockchain and driven by fundamental breakthroughs in distributed systems programming, with the development of the Rho-calculus. Below, find an overview of the most relevant papers and sources underpinning the Rhonix technology.
...
the Rhonix execution model is derived from the syntax and semantics of rho-calculus. The rho-calculus is a variant of the π-calculus that was introduced in 2004 to provide the first model of concurrent computation with reflection. “Rho” stands for reflective, higher-order.
...
- [Contracts, Composition, and Scaling: The Rholang specification](../../../../images/docs/build/rholang/rholang-spec-0.2.pdf)  
...
## Rhonix Platform Architecture

- [Rhonix Platform Architecture][archdoc] by Ed Eykholt, Lucius Meredith, Joseph Denman July 2017

**Abstract**: The Rhonix Platform Architecture description provides a
high-level blueprint of the Rhonix decentralized, economically
sustainable public compute infrastructure. While the Rhonix design is
