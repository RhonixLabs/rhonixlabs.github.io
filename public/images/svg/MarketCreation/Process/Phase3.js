...
const Phase3 = () => {
  return (
	...
	c26.1,1,28.1-23.4,48-28.2c14-3.4,27.4,10.5,35.8,45.4"
          fill="url(#phase3Diagram)"
        />
        <g className="dark:fill-white fill-black">
          <path
            d="M126.5,66V49.5h0h-2h-8V2h-2v51.5v2V66H36v-6h3V39H24v21h3v6H0v2h147v-2H126.5z M33,45h3v3h-3V45z M27,45h3v3
		h-3V45z M30,66v-6h3v6H30z M116.5,51.5h8V66h-2V55.5v-2h-2h-4V51.5z M116.5,55.5h4V66h-4V55.5z"
          />
		...
		66.5,45 66.5,47 68.5,47 68.5,45 	"
          ...
          <rect x="71.5" y="7" width="2" height="6" />
          <rect x="86.5" y="26" width="6" height="2" />
          <rect x="52.5" y="26" width="6" height="2" />
          <rect
            x="83.2"
            y="13.3"
            transform="matrix(0.7071 -0.7071 0.7071 0.7071 14.8694 64.4451)"
            width="4"
            height="2"
          />
          <rect
            x="57.8"
            y="38.7"
            transform="matrix(0.7071 -0.7071 0.7071 0.7071 -10.5844 53.9072)"
            width="4"
            height="2"
          />
          <rect
            x="84.2"
            y="37.7"
            transform="matrix(0.7071 -0.7071 0.7071 0.7071 -3.1285 71.893)"
            width="2"
            height="4"
          />
          <rect
            x="58.8"
            y="12.3"
            transform="matrix(0.7071 -0.7071 0.7071 0.7071 7.4132 46.4459)"
            width="2"
            height="4"
          />
        ...
        <g className="fill-rho-yellow">
          ...
          <path d="M74.5,35h-4v2h4V35z" />
          <path d="M66.5,25v4h2v-4H66.5z" />
          <path d="M76.5,25v4h2v-4H76.5z" />
          <path d="M68.5,29v6h2v-6H68.5z" />
          <path d="M74.5,29v6h2v-6H74.5z" />
        </g>
      </svg>
    </div>
  );
