...
async function generate() {
  const feed = new RSS({
    title: "Rhonix Blog",
    description: "Rhonix news, updates, and announcements.",
    site_url: "https://Rhonix.build",
    feed_url: "https://Rhonix.build/feed.xml",
    image_url: "https://Rhonix.build/api/og",
  });
  ...
  for (const frontmatter of sortedData) {
    ...
    feed.item({
      ...
      url: "https://Rhonix.build/blog/" + frontmatter.slug, // intentionally including slash here
      date: frontmatter.data.date,
      description: frontmatter.data.description,
      enclosure: {
        url: "https://Rhonix.build" + frontmatter.data.ogImage, // intentionally omitting slash here
        type: "image/png",
        size: stat.size,
      },
    });
